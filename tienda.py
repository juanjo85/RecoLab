...
class Tienda:
    # Construir tienda
    def __init__ (self,ID_tienda,nombre_tienda,direccion_tienda,categoria,imagen_portada_tienda,contacto):
...
class Producto:
    def __init__ (self,ID_producto,nombre_producto,descripcion_producto,imagen_producto,precio_producto):
